...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post('https://skill-swap-platform-backend.onrender.com/api/auth/register', { email, password });
  ...
  return (
    <div className="min-h-screen bg-[#111111] flex items-center justify-center px-4">
      <div className="bg-[#1E1E1E] border border-orange-600 p-8 rounded-2xl shadow-2xl w-full max-w-md">
        <h2 className="text-3xl font-bold text-orange-500 mb-6 text-center">Create Account</h2>
        ...
        <p className="mt-6 text-center text-orange-400">
          ...
          <Link to="/login" className="text-orange-500 hover:text-white font-medium">
            Log In
          </Link>
        </p>
      </div>
